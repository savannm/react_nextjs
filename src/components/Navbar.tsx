...
export default function Navbar() {
  ...
  const showcaseItems = [
    ...
    { name: "Google Maps", target: "", href: "/api_showcase/Google", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg> },
    { name: "OpenWeather", target: "", href: "/api_showcase/OpenWeather", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7Z" /><path d="M12.5 13V5a2.5 2.5 0 1 0-5 0v8" /><path d="M10 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" /></svg> },
    ...
    { name: "Youtube to Mp3", target: "_blank", href: "https://youtubemp3converter-production-c65d.up.railway.app", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg> },
    { name: "Google Analytics Dashboard", target: "", href: "/GoogleAnalytics", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg> },
  ];
  const resourceItems = [
    ...
    { name: "Claude", target: "", href: "/Resources/claude", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg> },
          ...
          */}
          ...
          <li className={styles.dropdown}>
            ...
            <div className={styles.dropdownContent}>
              ...
              <Link href="/GoogleAnalytics" className={styles.dropdownItem}>
          ...
          <li className={styles.dropdown}>
            ...
            <div className={styles.dropdownContent}>
              ...
              <Link href="/Resources/claude" className={styles.dropdownItem}>
                Claude
              </Link>
