...
export default function Navbar() {
  ...
  const showcaseItems = [
    ...
    { name: "Youtube to Mp3", target: "", href: "https://youtubemp3converter-production-c65d.up.railway.app", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg> },
  ];
  const resourceItems = [
